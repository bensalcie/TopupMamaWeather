...
import app.bensalcie.weathertask.core.utils.AppConstants.BASE_URL_RETROFIT_API
import app.bensalcie.weathertask.core.utils.AppConstants.REQUEST_TIME_OUT
import app.bensalcie.weathertask.core.utils.AppPreferences
import app.bensalcie.weathertask.domain.api.ApiService
import app.bensalcie.weathertask.core.utils.AppConstants.BASE_URL_GOOGLE_PLACES_API
...
//                    .addHeader("Authorization", "Bearer ${appPreferences.userToken ?: ""}")
    ...
    fun provideOkHttpClient(
        ...
        return if (app.bensalcie.weathertask.BuildConfig.DEBUG) {
