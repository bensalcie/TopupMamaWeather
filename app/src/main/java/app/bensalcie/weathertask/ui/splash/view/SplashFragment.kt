package app.bensalcie.weathertask.ui.splash.view
...
import app.bensalcie.weathertask.core.utils.AppConstants.SPLASH_TIME_OUT
import app.bensalcie.weathertask.databinding.FragmentSplashBinding
...
//    private val mViewModel: HomeViewModel by viewModels()
    ...
    override fun onResume() {
        ...
        Handler(Looper.getMainLooper()).postDelayed({
            (requireActivity() as MainDriverActivity).mViewModel.readyToFetch.observe(requireActivity(),
                { requirements ->
                    requirements?.let {
    ...
    private fun showNoGps(){
        dataBinder.apply {
            ...
            viewNoGps.cardTryAgain.setOnClickListener {
                (requireActivity() as MainDriverActivity).turnOnGPS()
            }
        }
    }
    ...
    private fun showTakePermissions(){
        dataBinder.apply {
            ...
            viewTakePermissions.cardTryAgain.setOnClickListener {
                (requireActivity() as MainDriverActivity).requestLocationPermission()
            }
        }
    }
