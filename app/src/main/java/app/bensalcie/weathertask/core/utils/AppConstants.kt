...
object AppConstants {
    ...
    const val BASE_URL_RETROFIT_API: String = app.bensalcie.weathertask.BuildConfig.SERVER_URL
    const val BASE_URL_GOOGLE_PLACES_API: String = app.bensalcie.weathertask.BuildConfig.GOOGLE_URL
    const val WEATHER_API_KEY :String = app.bensalcie.weathertask.BuildConfig.WEATHER_API_KEY
    const val GOOGLE_PLACE_API_KEY : String = app.bensalcie.weathertask.BuildConfig.GOOGLE_PLACE_API_KEY
